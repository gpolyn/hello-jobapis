Attempt to succeed with jobapis jobs-multi php package per the script given on that package's repo (github.com/jobapis/jobs-multi/blob/master/README.md)...
